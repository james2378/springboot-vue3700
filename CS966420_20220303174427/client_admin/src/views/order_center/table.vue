<template>
	<el-main class="bg">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="order_date_" label="下单日期"
				v-if="user_group == '管理员' || $check_field('get','order_date_')" min-width="200">
                <template slot-scope="scope">
                	{{ $toTime(scope.row["order_date_"],"yyyy-MM-dd") }}
                </template>
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/order_center/table','set') || $check_action('/order_center/view','set') || $check_action('/order_center/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
