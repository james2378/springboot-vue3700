		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','user_account') || $check_field('add','user_account') || $check_field('set','user_account')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="用户账号" prop="user_account">
					<el-input id="user_account" v-model="form_sub['user_account']" placeholder="请输入用户账号"
							  v-if="user_group === '管理员' || (form_sub['user_registration_id'] && $check_field('set','user_account')) || (!form_sub['user_registration_id'] && $check_field('add','user_account'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','age') || $check_field('add','age') || $check_field('set','age')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="年龄" prop="age">
					<el-input id="age" v-model="form_sub['age']" placeholder="请输入年龄"
							  v-if="user_group === '管理员' || (form_sub['user_registration_id'] && $check_field('set','age')) || (!form_sub['user_registration_id'] && $check_field('add','age'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','membership_level') || $check_field('add','membership_level') || $check_field('set','membership_level')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="会员等级" prop="membership_level">
					<el-input id="membership_level" v-model="form_sub['membership_level']" placeholder="请输入会员等级"
							  v-if="user_group === '管理员' || (form_sub['user_registration_id'] && $check_field('set','membership_level')) || (!form_sub['user_registration_id'] && $check_field('add','membership_level'))"></el-input>
					<div v-else-if="$check_field('get','membership_level')">{{form_sub['membership_level']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','member_discount') || $check_field('add','member_discount') || $check_field('set','member_discount')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="会员折扣" prop="member_discount">
					<el-input id="member_discount" v-model="form_sub['member_discount']" placeholder="请输入会员折扣"
							  v-if="user_group === '管理员' || (form_sub['user_registration_id'] && $check_field('set','member_discount')) || (!form_sub['user_registration_id'] && $check_field('add','member_discount'))"></el-input>
					<div v-else-if="$check_field('get','member_discount')">{{form_sub['member_discount']}}</div>
				</el-form-item>
			</el-col>
			<el-col :xs="24" :sm="12" :lg="8">
				<el-form-item>
