...
const routes = [
	...
	// 猫猫用品路由
	{
		path: '/cat_products/table',
		name: 'cat_products_table',
		component: () => import('../views/cat_products/table.vue')
	},
	{
		path: '/cat_products/view',
		name: 'cat_products_view',
		component: () => import('../views/cat_products/view.vue')
	},
	// 用户注册路由
	{
	...
	// 会员中心路由
	{
		path: '/membership_center/table',
		name: 'membership_center_table',
		component: () => import('../views/membership_center/table.vue')
	},
	{
		path: '/membership_center/view',
		name: 'membership_center_view',
		component: () => import('../views/membership_center/view.vue')
	},
	// 服务中心路由
	{
		path: '/service_centre/table',
		name: 'service_centre_table',
		component: () => import('../views/service_centre/table.vue')
	},
	{
		path: '/service_centre/view',
		name: 'service_centre_view',
		component: () => import('../views/service_centre/view.vue')
	},
	// 服务分类路由
	{
	...
	// 预约管理路由
	{
		path: '/booking_management/table',
		name: 'booking_management_table',
		component: () => import('../views/booking_management/table.vue')
	},
	{
		path: '/booking_management/view',
		name: 'booking_management_view',
		component: () => import('../views/booking_management/view.vue')
	},
